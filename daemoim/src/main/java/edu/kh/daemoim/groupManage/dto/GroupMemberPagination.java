...
public class GroupMemberPagination {
	...
	public GroupMemberPagination(int currentPage, int listCount) {
		super();
	...
	public GroupMemberPagination(int currentPage, int listCount, int limit, int pageSize) {
		super();
		this.currentPage = currentPage;
		this.listCount = listCount;
		this.limit = limit;
